...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Calculate your Body Mass Index and understand your health" },
      { property: "og:title", content: "BMI Calculator" },
      { property: "og:description", content: "Calculate your Body Mass Index and understand your health" },
